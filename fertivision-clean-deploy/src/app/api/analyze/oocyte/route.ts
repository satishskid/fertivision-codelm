...
export async function POST(request: NextRequest) {
  try {
    ...
    const analysisResult = await analyzeImage(image, 'oocyte', patientId, caseId, additionalNotes);
    ...
    console.error('Oocyte analysis error:', error);
