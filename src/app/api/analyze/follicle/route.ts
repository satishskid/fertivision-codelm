...
export async function POST(request: NextRequest) {
  try {
    ...
    const analysisResult = await analyzeImage(image, 'follicle', patientId, caseId, additionalNotes);
    ...
    console.error('Follicle analysis error:', error);
