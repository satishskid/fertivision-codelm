...
export default async function Dashboard() {
  ...
  // Mock user data for demo (replace with real database calls)
  const user = {
    id: 1,
            ...
            <div className="mb-2">
              <div className="text-2xl font-bold text-gray-900">
                {user.subscription_plan === 'free' ? 'Free' : 
                 user.subscription_plan === 'professional' ? '₹2,999' : '₹9,999'}
              </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow group">
